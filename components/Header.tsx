...
const Header: React.FC<HeaderProps> = ({ persona }) => {
  ...
  return (
    <nav className={`bg-white border-b-4 transition-colors duration-500 ${isEmergency ? 'border-orange-600' : 'border-blue-700'} sticky top-0 z-50`}>
        ...
        <div className="flex justify-between h-20">
          ...
          <div className="flex items-center gap-4 md:gap-8">
            <div className="hidden md:flex gap-6 font-semibold text-gray-600">
              ...
              <a href="#" className="hover:text-blue-700">Rebates</a>
              <a href="#" className="hover:text-blue-700">Areas</a>
            </div>
            ...
            <button className={`hidden sm:block px-6 py-2.5 rounded-full font-bold text-white shadow-lg transition-all transform hover:scale-105 active:scale-95 ${isEmergency ? 'bg-orange-600 hover:bg-orange-700' : 'bg-blue-700 hover:bg-blue-800'}`}>
              BOOK NOW
            </button>
          </div>
        </div>
